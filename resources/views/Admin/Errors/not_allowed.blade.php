...
<html lang="en">
  <head>
    ...
    <link rel="shortcut icon" href="{{url('/')}}/AdminAssets/favicon.ico" type="image/x-icon"/>
    <meta name="description" content="Tabler comes with tons of well-designed components and features. Start your adventure with Tabler and make your dashboard great again. For free!"/>
    <meta name="canonical" content="https://preview.tabler.io/error-500.html">
    ...
    <div class="page page-center">
      <div class="container-tight py-4">
        <div class="empty">
          ...
          <p class="empty-title">We are sorry but you are not allowed to access this page</p>
          {{-- <p class="empty-subtitle text-secondary">
            We are sorry but you are not allowed to access this page
          </p> --}}
          <div class="empty-action">
            <a href="{{url('/')}}/AdminAssets" class="btn btn-primary">
