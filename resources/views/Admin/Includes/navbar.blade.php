            ...
            <div class="container-xl">
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('Admin.roles.list')}}">
                      List
                    </a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('Admin.modules.list')}}">
                      List
                    </a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('Admin.sponsers.list')}}">
                      List
                    </a>
                  </div>
                </li>
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('Admin.general_settings.pages.list')}}">
                    Pages
                    </a>
                    <a class="dropdown-item" href="{{route('Admin.supports.list')}}">
                    App Support
                    </a>
                    <a class="dropdown-item" href="{{route('Admin.requestUpdate.list')}}">
                    Request For Updates
                    </a>
                  </div>
                </li>
