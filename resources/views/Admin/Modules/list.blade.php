...
<div class="page-header d-print-none">
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         ...
         <div class="col-1">
            <h2 class="page-title">
               @if(in_array('Create module',Session::get('permission_list')))
            <a class="btn btn-primary rounded" style="margin-left:20px !important" href="{{route('Admin.modules.create')}}" >Create</a>
            @endif
            </h2>
         </div>
      </div>
...
<script>
   ...
   function _edit(module_id)
   {
        ...
        $.ajax({
                    ...
                    type: "POST",
                    url: "{{url('/api/get-profile-fields')}}",
   ...
   $("#edit_form").on("submit", function(e) {
      ...
      loader(true);
            ...
            url: "{{url('/api/store-profile-fields')}}",
            type: 'POST',
   ...
   function _upload_csv(module_id,table_name,from,filter)
   {
      ...
      $.ajax({
               ...
               type: "POST", 
               url: "{{url('/api/module-managers/upload-csv-get')}}",
   ...
   function change_status(_this)
   {
        ...
        var module_manager =  $(_this).attr('module_manager_id');
            ...
            $.ajax({
               ...
               type: "PUT", 
               url: "{{url('/')}}"+"/api/module-managers/"+module_manager+"/update-status?active="+value,
               success: function(response) {
        ...
        swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                                    ...
                                    type: "DELETE",
                                    url: "{{url('/api/module-managers')}}/"+id,
                                    data: {id : id},
                                    success: function(response) {
                                    toastr.success(response.message);
                                    _DataTable.ajax.reload();
   ...
   function csv_file_store()
   {
      ...
      loader(true);
         ...
         $.ajax({
                     ...
                     type: "POST",
                     url: "{{url('/api/module-managers/upload-csv-store')}}",
                     data: formData,
                     processData: false,
                     contentType: false,
                     success: function(response) {
   ...
   function edit_section_data(_this)
   {
      ...
      $.ajax({
                    ...
                    type: "POST",
                    url: "{{url('/api/section-data/update')}}",
        ...
        swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                                    ...
                                    type: "POST",
                                    url: "{{url('/api/section-data/delete')}}",
