...
<html lang="en">
  <head>
    ...
    <title>Account Verification- {{env('ADMIN_APP_TITLE')}}</title>
      ...
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="./" method="get" autocomplete="off" novalidate>
          <div class="card-body">
            ...
            <p class="text-secondary mb-4">Please check your email and enter otp to verify your account</p>
            <div class="mb-3">
              <label class="form-label">OTP Code</label>
              <input type="text" class="form-control code" placeholder="OTP Code">
            </div>
            <div class="form-footer">
              <button type="button"  class="btn btn-primary w-100 submit">
              Verify
              </button>
            </div>
          </div>
