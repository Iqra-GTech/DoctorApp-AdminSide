...
<html lang="en">
  <head>
    ...
    <title>Forget Password - {{env('ADMIN_APP_TITLE')}}</title>
      ...
      <div class="container container-tight py-4">
        ...
        <form class="card card-md" action="./" method="get" autocomplete="off" novalidate>
          <div class="card-body">
            ...
            <p class="text-secondary mb-4">Enter your email address and you will receive an otp.</p>
            <div class="mb-3">
