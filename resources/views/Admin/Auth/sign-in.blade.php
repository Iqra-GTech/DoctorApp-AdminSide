...
<html lang="en">
  <head>
    ...
    <title>Sign In - {{env('ADMIN_APP_TITLE')}}</title>
    ...
    <link rel="icon" href="{{url('/')}}/AdminAssets/favicon.ico" type="image/x-icon"/>
                          ...
                          success: function(response) {
                            ...
                            console.log(response);
                              ...
                              if(response.data.user.verified == 0)
                              {
                                ...
                                window.location.href = "{{route('Admin.accountVerification')}}";
                              }
