   ...
   <div class="container-xl">
      ...
      <div class="col-6">
         <div class="form-group mt-2">
            ...
            <img src="<?php echo e(url('/logo-placeholder.png')); ?>" id="module_icon_image" width="50" height="50" class="mt-2" >
         </div>
      </div>
      <div class="col-6">
         <div class="form-group mt-2">
            ...
            <img src="<?php echo e(url('/logo-placeholder.png')); ?>" id="module_header_icon_image" width="50" height="50" class="mt-2" >
         </div>
      </div>
   </div>
      <div class="row" >
...
function getTables()
{
   loader(true);
            $.ajax({
               ...
               type: "GET",
               url: "<?php echo e(url('api/module-managers/get-tables')); ?>",
...
function getColumns(table_name)
{
   ...
   if(table_name == 'users')
   {
      ...
      <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
      <?php if($role->id != '1'): ?>
      option +=    '<option value="role.<?php echo e($role->id); ?>" ><?php echo e($role->name); ?></option>';
      <?php endif; ?>
      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
   ...
   loader(true);
            ...
            $.ajax({
               ...
               url: "<?php echo e(url('api/module-managers/get-columns')); ?>",
               success: function(response) 
               {
                  loader(false);
            ...
            loader(true);
               return new Promise(function(resolve, reject) {
                     ...
                     $.ajax({
                        ...
                        type: "POST",
                        url: "<?php echo e(url('api/module-managers/comma-separated-values-array-from-linked-table')); ?>",
                        data: data,
                        success: function(response) 
                        {
                           loader(false);
            ...
            for (let i = 0; i < detail.length; i++) {
               ...
               if(!/^[A-Za-z\s]*$/.test($(detail[i]).attr('_option')))
               {
                  ...
                  success: function(response) {
                     ...
                     window.location.href = "<?php echo e(route('Admin.modules.list')); ?>";
...
<?php /**PATH D:\Gtech\admin side\TheDoctorApp\resources\views/Admin/Modules/create.blade.php ENDPATH**/ ?>