...
function fetch_all_data() {
    $(document).ready(function() {
        ...
        _DataTable = $('#table_id').DataTable({
            ...
            "ajax": {
                ...
                "type": "GET",
                "url": "<?php echo e(url('api/request-updates')); ?>",
            ...
            "columns": [{
                ...
                "data": "resolved",
                    "render": function(data, type, row) {
                        return `
                        <?php if(in_array('Change Requests Status',Session::get('permission_list'))): ?>
   ...
   function change_status(_this)
   {
        ...
        var request_updates_id =  $(_this).attr('request_updates_id');
            ...
            $.ajax({
               ...
               type: "PUT",
               url: "<?php echo e(url('/')); ?>"+"/api/request-updates/"+request_updates_id,
               data: {'resolved' : value },
   ...
   function _discription(id)
   {
      ...
      $.ajax({
               ...
               type: "GET",
               url: "<?php echo e(url('/api/request-updates')); ?>/"+id,
               success: function(response) {
...
<?php /**PATH D:\Gtech\admin side\TheDoctorApp\resources\views/Admin/RequestUpdate/list.blade.php ENDPATH**/ ?>