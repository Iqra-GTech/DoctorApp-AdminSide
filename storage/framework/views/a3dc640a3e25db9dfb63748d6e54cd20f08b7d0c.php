...
function formatDate(date) {
  ...
  return `${day}-${month}-${year}`;
   ...
   function logout(e){
    ...
    var this_token = "Bearer <?php if(session()->has('token')): ?><?php echo e(session('token')); ?><?php endif; ?>"
          $.ajax({
              headers: {
 ...
 function count_notification()
 {
            ...
            type: "POST",
            url: "<?php echo e(url('api/count-notifications')); ?>",
            data: {
            "id" : "0",
            },
            success: function(response) {
 ...
 function get_notification(from,to)
 {
            ...
            type: "POST",
            url: "<?php echo e(url('api/get-notifications')); ?>",
            data: {
            "id" : "0",
            "from": from, 
            "to" : to,     
 ...
 function move_to_url(type,id)
{
    ...
    {
        url = "<?php echo e(url('/general-settings/supports/list')); ?>?notify_id="+id;
    }
    else if(type == "request_to_doctor" || type == "request_to_doctor_accepted" || type == "request_to_doctor_accepted_by_patient")
    {
        url = "<?php echo e(url('/general-settings/request-updates/list')); ?>?notify_id="+id;
    }
    ...
    $.ajax({
            ...
            type: "POST",
            url: "<?php echo e(url('api/single-notifications-mark-as-read')); ?>",
            data: {
            "id" : "0",
            "notification_id" : id
            },
...
function all_read()
{
    $.ajax({
            ...
            type: "POST",
            url: "<?php echo e(url('api/all-notifications-mark-as-read')); ?>",
            data: {
            "id" : "0"
            },
            success: function(response) {
...
<?php /**PATH D:\Gtech\admin side\TheDoctorApp\resources\views/Admin/Includes/footer.blade.php ENDPATH**/ ?>