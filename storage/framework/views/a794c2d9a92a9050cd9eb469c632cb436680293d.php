...
<div class="page-header d-print-none">
   <div class="container-xl">
      <div class="row g-2 align-items-center">
         ...
         <div class="col-1">
            <h2 class="page-title">
               <?php if(in_array('Create page',Session::get('permission_list'))): ?>
            ...
            "columns": [{
                ...
                },
                {
                    ...
                    "render": function(data, type, row) {
                        return `
                        <?php if(in_array('Change page status',Session::get('permission_list'))): ?>
                    ...
                    "render": function(data, type, row) {
                     ...
                     <div class="text-dark dropdown">
                           ...
                           <div class="dropdown-menu">
                            <?php if(in_array('Edit page',Session::get('permission_list'))): ?>
                              <a class="dropdown-item" role="button" href="<?php echo e(Url('/general-settings/pages/edit')); ?>/${row.id}" >Edit</a>
                              <?php endif; ?>

                              <?php if(in_array('Delete page',Session::get('permission_list'))): ?>
   ...
   function change_status(_this)
   {
        ...
        var user_id =  $(_this).attr('user_id');
            ...
            $.ajax({
               ...
               type: "PUT",
               url: "<?php echo e(url('/')); ?>"+"/api/pages/"+user_id+"/update-status?status="+value,
        ...
        swal({
                ...
                if (willDelete) {
                    ...
                    $.ajax({
                                    ...
                                    type: "DELETE",
                                    url: "<?php echo e(url('/api/pages')); ?>/"+id,
                                    data: {id : id},
                                    success: function(response) {
                                    toastr.success(response.message);
                                    _DataTable.ajax.reload();
...
<?php /**PATH D:\Gtech\admin side\TheDoctorApp\resources\views/Admin/Pages/list.blade.php ENDPATH**/ ?>