                  ...
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <select class="date_select" onchange="counterFunction();" style="border-color: transparent;outline: none;">
                        <option value="<?php echo e(date('Y-m-d')); ?>" selected>Today</option>
                        <option value="<?php echo e($monday); ?>">This Week</option>
                        <option value="<?php echo e(date('Y-m-01')); ?>">This Month</option>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="d-flex align-items-center">
                      ...
                      <div class="ms-auto lh-1">
                       <a href="<?php echo e(url('/')); ?>/users/list" class="btn btn-secondary btn-sm">View Users</a>
                      </div>
                    </div>
                    <div class="d-flex justify-content-between mt-5">
...
function counterFunction() {
    ...
    $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('api/counter-function')); ?>",
        data: {
...
function get_no_of_records(_this)
{
  ...
  $.ajax({
        ...
        type: "POST",
        url: "<?php echo e(url('api/get-no-of-records')); ?>",
        data: {
...
<?php /**PATH D:\Gtech\admin side\TheDoctorApp\resources\views/Admin/dashboard.blade.php ENDPATH**/ ?>